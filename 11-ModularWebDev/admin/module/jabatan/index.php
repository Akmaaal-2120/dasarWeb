<div class="container-fluid">
    <div class="row">
        <?php
        // Memuat sidebar/menu navigasi
        require '../11-ModularWebDev/template/home.php';
        ?>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php
            // Memeriksa apakah ada pesan flash yang tersimpan di sesi
            if (isset($_SESSION['_flashdata'])) {
                echo "<br>";
                foreach ($_SESSION['_flashdata'] as $key => $val) {
                    echo get_flashdata($key); // Fungsi untuk menampilkan dan menghapus pesan
                }
            }
            ?>
            ...
            <div class="table-responsive small">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        // Logika menampilkan data dari database
                        $no = 1;
                        // PERHATIAN: Masih menggunakan mysqli_query, harus diubah ke pg_query untuk PostgreSQL
