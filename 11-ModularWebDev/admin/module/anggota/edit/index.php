<div class="container-fluid">
    <div class="row">
        ...
        // 1. Pengambilan ID dari URL
        $id = $_GET['id'];

        // 2. Query untuk mengambil data anggota, jabatan, dan login user
        // CATATAN: Query ini rentan SQL Injection! Lihat saran di bawah.
        $query = "SELECT * FROM anggota a, jabatan j, users u 
                  WHERE a.jabatan_id = j.id 
                  AND a.user_id = u.id 
                  AND a.user_id = '$id'";
